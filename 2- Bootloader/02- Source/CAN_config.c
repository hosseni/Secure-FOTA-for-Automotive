...
CAN_FilterInitTypeDef  CAN_FilterInitStruct_4 = { 0x00800000 , 0x00800000 , CAN_FilterMode_IdMask ,  3  , CAN_FilterScale_32bit , CAN_Filter_FIFO0 , ENABLE}; // ID = 0X04

CAN_FilterInitTypeDef  CAN_FilterInitStruct_5 = { 0x00A00000 , 0x00A00000 , CAN_FilterMode_IdMask ,  4  , CAN_FilterScale_32bit , CAN_Filter_FIFO0 , ENABLE}; // ID = 0X05

CAN_FilterInitTypeDef  CAN_FilterInitStruct_6 = { 0x00C00000 , 0x00C00000 , CAN_FilterMode_IdMask ,  5  , CAN_FilterScale_32bit , CAN_Filter_FIFO0 , ENABLE}; // ID = 0X06
